...
/*
//first part : Consommation des données du topic sujet 3 avant enregistrement
       ...
       Dataset<Row> df = session.read().format("kafka").option("kafka.bootstrap.servers", "localhost:9092")
        ...
        transformedDf.write()
           ...
           */
           // second part : Enregistrement des données dans une table sujet et de l'evolution des conso dans une table q3 par adresse/années
